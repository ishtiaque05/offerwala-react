    ...
    <div className={classes.root}>
      <AppBar className={classes.slider} position="fixed" color="default">
        <ul className={ classes.ul }>
          ...
          <li className={ classes.li }>
            <NavLink className={ classes.anchor } activeClassName={ classes.tabActive } to="/deals/online-deals">
              Online Deals
            </NavLink>
          </li>
          <li className={ classes.li }>
            <NavLink className={ classes.anchor } activeClassName={ classes.tabActive } to="/deals/store-deals">
              Store Deals
            </NavLink>
          </li>
        </ul>
