        ...
        <main className={ classes.main }>
            ...
            <div>
                <Grid container justify="center">
                    <Grid item sm={6}>
                        <div style={{ textAlign: 'center', maxWidth: '270px', margin: '40px auto 0' }}>
            ...
            <div>
                <h2 className={ classes.headingPrimary }>What is influencer <span style={{ color: '#C32323' }}>marketing</span></h2>
                <div>
                    <h3 className={ classes.headingSecondary }>Influencers</h3>
                    <p>produce  engaging  content  &  grow  organic  dedicate  followers.  They  partner  up  with brands  that  is  relative  to  them  &  their  followers;  Makes  honest  recommendation helping brands to reach their target audience in a more organic way</p>
                    <h3 className={ classes.headingSecondary }>Influencer Marketing</h3>
                    <p>A form of marketing in which advertisers collaborate with online influencers to create a non-intrusive  and  authentic  recommendation  of  a  product  or  service  through  a  voice that is admired and trusted by the target audience.</p>
                </div>
                <h2 className={ classes.headingPrimary }>Why it <span style={{ color: '#C32323' }}>Works</span></h2>
                <div>
                    ...
                    <Grid container justify="center">
                        <Grid style={{ textAlign: "center" }} item md={ 4 }>
                            ...
                            <p>of subscribers say they <b>relate</b> to <b>influencers</b> more than traditional <b>celebrities</b></p>
                        </Grid>
                        <Grid style={{ textAlign: "center" }} item md={ 4 }>
                            <h4 className={ classes.headingTertiary }>6 in 10</h4>
                            <p>subscribers would follow <b>advice</b> on what to <b>buy</b> from their favorite <b>influencer</b> over their favorite <b>TV</b> or <b>movie personality</b></p>
                        </Grid>
                        <Grid style={{ textAlign: "center" }} item md={ 4 }>
                            <h4 className={ classes.headingTertiary }>4 in 10</h4>
                            <p>millennials on YouTube say their favorite <b>influencer understands</b> them better than their <b>friends</b></p>
                        </Grid>
                    </Grid>
                </div>
                <h2 className={ classes.headingPrimary }>What do we <span style={{ color: '#C32323' }}>provide</span></h2>
                <div>
                    <ul>
